...
using Taller.Chatbot.Dialogs;
using Taller.Chatbot.Services.AzureClu;

namespace Taller.Chatbot
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAzureCluService, AzureCluService>();
            // Create the bot as a transient. In this case the ASP Controller is expecting an IBot.
            services.AddTransient<RootDialog>();
            services.AddTransient<IBot, Bots.EchoBot<RootDialog>>();
